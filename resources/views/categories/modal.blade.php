        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="EditTitle">
                    Detail Categorie Data </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('categories.show', $data->id) }}" method="post" role="form"
                        ...
                        <div class="col mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input style="font-weight: bold; padding-left: 15px;" type="text" id="nameWithTitle"
                                    required class="form-control" name="name" disabled value="{{ $data->name }}" />
                            </div>
                            @error('name')
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                        class='bx bx-user'></i></span>
                                <textarea disabled class="form-control" id="basic-default-message" name="description" placeholder="Enter Description"
